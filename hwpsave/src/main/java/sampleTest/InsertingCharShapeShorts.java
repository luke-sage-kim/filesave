...
public class InsertingCharShapeShorts {
	 public static void main(String[] args) throws Exception {
	        String filename = "C:\\Temp\\sample11.hwpx";

	        HWPFile hwpFile = HWPReader.fromFile(filename);
	        if (hwpFile != null) {
	        	InsertingCharShapeShorts tmcs = new InsertingCharShapeShorts();
	            tmcs.test(hwpFile);//@@@@@
	    ...
	    private InsertingCharShapeShorts() {
	        hwpFile = null;
	    }
	    ...
	    private int createCharShape(boolean bold) {    //글자 모양을 설정하는 부분을 담당
	        ...
	        cs.getShadeColor().setValue(0x00FFFF);			//음영 색상을 설정
